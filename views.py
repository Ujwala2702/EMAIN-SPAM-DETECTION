...
def UploadDatasetAction(request):
    if request.method == 'POST':
        ...
        dataset = pd.read_csv("C:/Users/ujwal/Desktop/24.Email Spam Detection Using Machine Learning Algorithms\SpamDetection/Dataset/spam_ham_dataset.csv",encoding='iso-8859-1',nrows=50)
